...
export function DiscoveryCard({
  ...
  return (
    ...
    // forward. Default, not raised: this renders once per result in a list
    // that can run to dozens of cards, which is exactly the repeated/routine
    // case --elev-raised is no longer reserved for (see card.tsx).
    <Card>
